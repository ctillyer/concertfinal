  ...
  <body>
          ...
          <section id="section591">
              <div class="container">
                  <div class="row">
                      <div class="col-sm-8">
                          ...
                          <div class="header-banner banner-slide">
                                  <div class="item-slide">
                                      <figure>
                                          <img src="assets/images/slide-home6/slide45.jpg" alt="img">
                                      </figure>
                      ...
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">The Beatles</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">Date: 25/6/2021</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
                               ...
                               <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">Price: 20£<br>
                                  (pay at door)</br></p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
    ...
    <?php 
      ...
      if ($password === "adminexample"){
        echo "<center>People coming: $julycount5</centre>";
      }
     ?> 
