  ...
  <body>
          ...
          <section id="section591">
              <div class="container">
                  <div class="row">
                      ...
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">The Front Bottoms</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">Date: 20/6/2021</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
    ...
    <?php 
      ...
      if ($password === "adminexample"){
        echo "<center>People coming: $julycount2</centre>";
      }
     ?> 
