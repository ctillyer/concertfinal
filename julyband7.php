  ...
  <body>
          ...
          <section id="section591">
              <div class="container">
                  <div class="row">
                      <div class="col-sm-8">
                          ...
                          <div class="header-banner banner-slide">
                                  <div class="item-slide">
                                      <figure>
                                          <img src="assets/images/slide-home6/slide47.jpg" alt="img">
                                      </figure>
                      ...
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">Panic! At the Disco</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
                                  <p class="icon-box-desc">Date: 29/6/2021</p>
                              </figure>
                              </div><br>
                      <div class="col-sm-4">
                              <figure>
    ...
    <?php 
      ...
      if ($password === "adminexample"){
        echo "<center>People coming: $$julycount7</centre>";
      }
     ?> 
